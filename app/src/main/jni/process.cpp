...
JNIEXPORT void JNICALL Java_app_simple_inure_terminal_TermExec_sendSignal(JNIEnv *env, jclass clazz,
                                                                          jint procId,
                                                                          jint signal) {
    kill(procId, signal);
}
...
Java_app_simple_inure_terminal_TermExec_waitFor(JNIEnv *env, jclass clazz, jint procId) {
    int status;
...
JNIEXPORT jint JNICALL
Java_app_simple_inure_terminal_TermExec_createSubprocessInternal(JNIEnv *env, jclass clazz,
