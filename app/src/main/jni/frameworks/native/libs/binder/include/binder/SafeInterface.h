...
// ParcelHandler is responsible for writing/reading various types to/from a Parcel in a generic way
        ...
        public:
            ...
            template<typename E>
            typename std::enable_if<std::is_enum<E>::value, status_t>::type
            read(const Parcel &parcel,
                 E *e) const {
            ...
            template<typename T>
            typename std::enable_if<std::is_base_of < Flattenable < T>, T>::value, status_t>
            ...
            ::type read(
                ...
                *t = new T{};
                return callParcel("read(sp<Flattenable>)",
            ...
            ::type write(
                ...
                return callParcel("write(sp<Flattenable>)",
                                  [&]() { return parcel->write(*(t.get())); });
            }

            template<typename T>
            typename std::enable_if<std::is_base_of < LightFlattenable < T>, T>::value, status_t>
            ...
            typename std::enable_if<std::is_same < NH, sp < NativeHandle>>::value, status_t>
            ...
            typename std::enable_if<std::is_base_of<Parcelable, T>::value, status_t>::type read(
                ...
                return callParcel("readParcelableVector",
                                  [&]() { return parcel.readParcelableVector(v); });
            }
            ...
            struct HandleInt<true, 4, I> {
                ...
                static status_t write(const ParcelHandler &handler, Parcel *parcel, I i) {
                    return handler.callParcel("writeInt32",
                                              [&]() { return parcel->writeInt32(i); });
                }
            };
            ...
            struct HandleInt<false, 4, I> {
                ...
                static status_t write(const ParcelHandler &handler, Parcel *parcel, I i) {
                    return handler.callParcel("writeUint32",
                                              [&]() { return parcel->writeUint32(i); });
                }
            };
            ...
            struct HandleInt<true, 8, I> {
                ...
                static status_t write(const ParcelHandler &handler, Parcel *parcel, I i) {
                    return handler.callParcel("writeInt64",
                                              [&]() { return parcel->writeInt64(i); });
                }
            };
            ...
            struct HandleInt<false, 8, I> {
                ...
                static status_t write(const ParcelHandler &handler, Parcel *parcel, I i) {
                    return handler.callParcel("writeUint64",
                                              [&]() { return parcel->writeUint64(i); });
                }
            };

            template<typename I>
            typename std::enable_if<std::is_integral<I>::value, status_t>::type
            read(const Parcel &parcel,
                 I *i) const {
        ...
        private:
            ...
            status_t callParcel(const char *name, Function f) const {
                ...
                if (CC_UNLIKELY(error != NO_ERROR)) {
                    ALOG(LOG_ERROR, mLogTag, "Failed to %s, (%d: %s)", name, error,
                         strerror(-error));
#if SI_DUMP_CALLSTACKS
...
// function pointer
    ...
    private:
        ...
        struct ArgsMatchParams<std::tuple < Args...>, std::tuple<Params...>> {
            ...
            elementsMatch() {
                if (!DecayedElementsMatch<Index, std::tuple < Args...>, std::tuple <
                                                                        Params...>>::value) {
                    return false;
                }
    ...
    private:
        ...
        static typename std::enable_if<
                ...
                typename std::tuple_element<I, std::tuple < Params...>>::type>
