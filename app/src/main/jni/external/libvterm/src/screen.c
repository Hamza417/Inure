...
{
  ScreenCell *new_buffer = (ScreenCell*) vterm_allocator_malloc(screen->vt, sizeof(ScreenCell) * new_rows * new_cols);
...
static int resize(int new_rows, int new_cols, VTermPos *delta, void *user)
{
  ...
  screen->sb_buffer = (VTermScreenCell*) vterm_allocator_malloc(screen->vt, sizeof(VTermScreenCell) * new_cols);
...
static VTermScreen *screen_new(VTerm *vt)
{
  ...
  screen->sb_buffer = (VTermScreenCell*) vterm_allocator_malloc(screen->vt, sizeof(VTermScreenCell) * cols);
