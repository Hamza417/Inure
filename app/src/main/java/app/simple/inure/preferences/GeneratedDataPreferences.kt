...
object GeneratedDataPreferences {
    ...
    private const val generatorFlags = "generator_flags_c"

    const val NAME = 1L shl 0
    const val PACKAGE_NAME = 1L shl 1
    const val VERSION = 1L shl 2
    const val INSTALL_DATE = 1L shl 3
    const val UPDATE_DATE = 1L shl 4
    const val MINIMUM_SDK = 1L shl 5
    const val TARGET_SDK = 1L shl 6
    const val SIZE = 1L shl 7
    const val PLAY_STORE = 1L shl 8
    const val FDROID = 1L shl 9
    const val AMAZON_STORE = 1L shl 10
    const val GALAXY_STORE = 1L shl 11
