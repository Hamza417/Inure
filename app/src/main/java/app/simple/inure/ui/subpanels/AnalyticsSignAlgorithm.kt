...
class AnalyticsSignAlgorithm : ScopedFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        analyticsDataViewModel.getSignAlgorithmData().observe(viewLifecycleOwner) {
    ...
    companion object {
        fun newInstance(e: Entry?): AnalyticsSignAlgorithm {
            val args = Bundle()
            args.putParcelable(BundleConstants.entry, e)
            val fragment = AnalyticsSignAlgorithm()
            fragment.arguments = args
            return fragment
        }

        const val TAG = "AnalyticsSignAlgorithm"
    }
}
