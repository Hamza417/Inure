...
import app.simple.inure.adapters.terminal.AdapterColor
import app.simple.inure.decorations.overscroll.CustomVerticalRecyclerView
import app.simple.inure.extension.fragments.ScopedFragment

class TerminalColor : ScopedFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerView.adapter = AdapterColor()
    }

    companion object {
        fun newInstance(): TerminalColor {
            val args = Bundle()
            val fragment = TerminalColor()
