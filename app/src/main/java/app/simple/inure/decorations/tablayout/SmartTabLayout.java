 ...
 * {@link #setViewPager2(ViewPager2)} providing it the ViewPager this
 * layout
 * is being used for.
 * <p>
...
public class SmartTabLayout extends HorizontalScrollView {
    ...
    public SmartTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabBackgroundResId = a.getResourceId(R.styleable.SmartTabLayout_defaultTabBackground, tabBackgroundResId);
        textAllCaps = a.getBoolean(R.styleable.SmartTabLayout_defaultTabTextAllCaps, textAllCaps);
        textColors = a.getColorStateList(R.styleable.SmartTabLayout_defaultTabTextColor);
        textSize = a.getDimension(R.styleable.SmartTabLayout_defaultTabTextSize, textSize);
        textHorizontalPadding = a.getDimensionPixelSize(R.styleable.SmartTabLayout_defaultTabTextHorizontalPadding, textHorizontalPadding);
        textMinWidth = a.getDimensionPixelSize(R.styleable.SmartTabLayout_defaultTabTextMinWidth, textMinWidth);
        customTabLayoutId = a.getResourceId(R.styleable.SmartTabLayout_customTabTextLayoutId, customTabLayoutId);
        customTabTextViewId = a.getResourceId(R.styleable.SmartTabLayout_customTabTextViewId, customTabTextViewId);
        distributeEvenly = a.getBoolean(R.styleable.SmartTabLayout_distributeEvenly, distributeEvenly);
        clickable = a.getBoolean(R.styleable.SmartTabLayout_clickable, clickable);
        titleOffset = a.getLayoutDimension(R.styleable.SmartTabLayout_titleOffset, titleOffset);
        a.recycle();
     ...
     * {@link #setViewPager2(ViewPager2)} otherwise it will not get set
     *
    ...
    public interface TabProvider {
         ...
         */
        View createTabView(ViewGroup container, int position, BaseFragmentStateAdapter adapter);
