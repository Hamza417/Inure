...
class PopupBootManagerSortingStyle(view: View) : BasePopupWindow() {
    ...
    init {
        ...
        reversedCheckBox.setChecked(BootManagerPreferences.isSortingReversed())
        ...
        reversedCheckBox.setOnCheckedChangeListener { isChecked ->
            BootManagerPreferences.setSortingReversed(isChecked)
        }
    }
    ...
    private fun TextView.onClick(style: String) {
        this.setOnClickListener {
            BootManagerPreferences.setSortingStyle(style)
            dismiss()
        }
    }
