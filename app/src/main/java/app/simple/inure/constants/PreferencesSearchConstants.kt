...
object PreferencesSearchConstants {
    ...
    private val behaviourData = arrayListOf(
            ...
            PreferenceSearchModel(R.drawable.switch_thumb, R.string.damping_ratio, R.string.damping_ratio_desc, options, scrolling, behaviour),
            PreferenceSearchModel(R.drawable.ic_stiffness, R.string.stiffness, R.string.stiffness_desc, options, scrolling, behaviour),
