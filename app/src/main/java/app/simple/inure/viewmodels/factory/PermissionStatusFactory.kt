...
class PermissionStatusFactory internal constructor(private val application: Application, private val packageInfo: PackageInfo, private val permissionInfo: PermissionInfo) : ViewModelProvider.AndroidViewModelFactory(application) {
