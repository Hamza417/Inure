...
class FilePreparingViewModelFactory(private val application: Application, private val param: ApplicationInfo)
    : ViewModelProvider.AndroidViewModelFactory(application) {

    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        @Suppress("UNCHECKED_CAST") // Cast is fine
        if (modelClass.isAssignableFrom(FilePreparingViewModel::class.java)) {
