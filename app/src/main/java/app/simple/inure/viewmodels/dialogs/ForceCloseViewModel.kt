...
class ForceCloseViewModel(application: Application, val packageInfo: PackageInfo) : AndroidViewModel(application) {
    ...
    private fun runCommand() {
        viewModelScope.launch(Dispatchers.IO) {
            ...
            kotlin.runCatching {
                ...
                Shell.su("am force-stop ${packageInfo.packageName}").submit { shellResult ->
                    kotlin.runCatching {
