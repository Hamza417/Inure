...
class XMLViewerViewModelFactory(val packageInfo: PackageInfo, private val isManifest: Boolean, @Nullable private val pathToXml: String, val application: Application, private val accentColor: Int)
